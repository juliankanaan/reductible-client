...
function givePreview(data) {
  var preview = []; // pick out three random elements of JSON array

  rand1 = Math.random() * data.length;
  rand2 = Math.random() * data.length;
  rand3 = Math.random() * data.length;
...
//# sourceMappingURL=create.js.2facd3161f307ced2929.hot-update.js.map