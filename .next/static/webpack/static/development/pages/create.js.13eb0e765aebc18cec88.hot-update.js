...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_2__["default"])(UrlForm, [{
    ...
    value: function handleSubmit(event) {
      ...
      var res = _helpers_helper_js__WEBPACK_IMPORTED_MODULE_8___default.a.callAsync(this.state.url, this.state.descStart, this.state.descEnd, this.state.priceColumn).then(function (data) {
        console.log(data);
...
//# sourceMappingURL=create.js.13eb0e765aebc18cec88.hot-update.js.map