...
function (_React$Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Records, [{
    ...
    value: function componentDidMount() {
      ...
      fetch("http://localhost:4000/api/records/lookup?procedureDescription=xray&limit=50&hospital=Mount+Sinai", options).then(function (data) {
        return data.json();
      }).then(function (records) {
        _this2.setState(records);
...
//# sourceMappingURL=index.js.1b1c27d2278a0f826d81.hot-update.js.map